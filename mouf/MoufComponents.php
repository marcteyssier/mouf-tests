...
$moufManager->getConfigManager()->setConstantsDefinitionArray(array (
  ...
  'SECRET' => 
  array (
    'defaultValue' => 'hu00RjiFeGooFkZ5t89b',
    'type' => 'string',
...
$moufManager->setAllVariables(array (
  'splashDefaultControllersNamespace' => 'MoufTest\\Controllers\\',
  'splashDefaultViewsDirectory' => 'views/',
  'tdbmDefaultDaoNamespace_tdbmService' => 'MoufTest\\Model\\Dao',
  'tdbmDefaultBeanNamespace_tdbmService' => 'MoufTest\\Model\\Bean',
  ...
  'tdbmDefaultDaoNamespace' => 'MoufTest\\Model\\Dao',
  'tdbmDefaultBeanNamespace' => 'MoufTest\\Model\\Bean',
  ...
  array (
    ...
    array (
      ...
      array (
        'value' => 
        array (
          0 => '__anonymous__fefb_2065305935',
...
return new \\Doctrine\\Common\\Annotations\\CachedReader($reader, $container->get("defaultDoctrineCache"));',
  ...
  'brandDao' => 
  array (
    'class' => 'MoufTest\\Model\\Dao\\BrandDao',
    'external' => false,
    'constructor' => 
    array (
      0 => 
  ...
  'daoFactory' => 
  array (
    'class' => 'MoufTest\\Model\\Dao\\Generated\\DaoFactory',
    'external' => false,
    'setterBinds' => 
    array (
      'setBrandDao' => 'brandDao',
      'setCarDao' => 'carDao',
    ),
    'fieldProperties' => 
    array (
  ...
  array (
    ...
    array (
      ...
      1 => 
      array (
        'value' => '__anonymous__fefb_658924141',
        'parametertype' => 'object',
        'type' => 'string',
        'metadata' => 
        array (
      ...
      3 => 
      array (
        'value' => '__anonymous__fefb_1010748219',
        'parametertype' => 'object',
        'type' => 'string',
        'metadata' => 
        array (
...
',
  ...
  'rootController' => 
  array (
    'class' => 'MoufTest\\Controllers\\RootController',
    'external' => false,
    'weak' => false,
    'constructor' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        'value' => 
        array (
          'brands' => 'MoufTest\\Model\\Bean\\BrandBean',
          'cars' => 'MoufTest\\Model\\Bean\\CarBean',
        ),
        'type' => 'string',
        'metadata' => 
        array (
...
return rtrim(sys_get_temp_dir(), '/\\').'/mouftwigtemplatemain_'.$posixGetuid.str_replace(":", "", ROOT_PATH);
	...
	/**
	 * @return MoufTest\Model\Dao\Generated\DaoFactory
	 */
	...
	/**
	 * @return MoufTest\Controllers\RootController
	 */
